...
non_prior <- dbeta(theta, 1,1)
non_post <- dbeta(theta, parameters_non[1], parameters_non[2])

parameters_info <- BetaBernMod(3,1,obs_data)
info_prior <- dbeta(theta, 3,1)
info_post <- dbeta(theta, parameters_info[1], parameters_info[2])
